...
class AttributeType(StrEnum, metaclass=_MetaEnum):
    ...
    u_angle_sigma = "u_angle_sigma"
    u_band = "u_band"
    u_measured = "u_measured"
    u_pu = "u_pu"
    u_pu_sigma = "u_pu_sigma"
    u_rated = "u_rated"
    u_ref = "u_ref"
