...
class Edge : public Base {
  public:
    ...
    template <symmetry_tag sym> BranchOutput<sym> get_output(BranchSolverOutput<sym> const& edge_solver_output) const {
        ...
        output.p_from_sigma = base_power<sym> * edge_solver_output.p_f_sigma;
        output.q_from_sigma = base_power<sym> * edge_solver_output.q_f_sigma;
        output.i_from_sigma = base_i_from() * edge_solver_output.i_f_sigma;
        output.p_to_sigma = base_power<sym> * edge_solver_output.p_t_sigma;
        output.q_to_sigma = base_power<sym> * edge_solver_output.q_t_sigma;
        output.i_to_sigma = base_i_to() * edge_solver_output.i_t_sigma;
